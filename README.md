...
| 版本 | 日期 | 说明 |
|------|------|------|
| **V2.2.1（开发中）** | 2026-08-11 | 类目链接执行同源与末级校验，拒绝纯文字帮助链、普通data-id和外域/c；缓存先比较可信度再比较长度；修正Scrapling重试验证，339项测试通过 ([分支](https://github.com/bendankill/Scrapling_2.0/tree/V2.2.1)) |
