...
| 版本 | 日期 | 说明 |
|------|------|------|
| V2.2.1（开发中） | 2026-08-11 | 基于V2.2.0完善列表页真实类目层级提取，尚未验收为稳定版 ([分支](https://github.com/bendankill/Scrapling_2.0/tree/V2.2.1)) |
| **V2.2.0（当前稳定）** | 2026-08-11 | 产品输出字段中文化、`campaign_name`→“链接打标”、扩展信息无损冲突处理、现有类目层级拆分；完整测试236项通过 ([分支](https://github.com/bendankill/Scrapling_2.0/tree/V2.2.0)) |
...
| V2.1.2 | 2026-08-04 | 删除断点续抓、任务总耗时打印、有界图片Future+进度日志+wait调度 |
...
> 当前已验收稳定版本为 **V2.2.0**（`V2.2.0` 分支）。`V2.2.1` 已创建用于类目层级完善开发，在完成最终核验前不视为稳定版。`main` 仅维护GitHub默认主页文档，运行时请切换到对应版本分支。完整变更记录见 [CHANGELOG.md](CHANGELOG.md)。
